    ...
    <div className="container">
      ...
      <Card className="card">
        ...
        <Collapse defaultActiveKey={["1"]} className="collapse">
          <Panel header={<span className="panelHeader">How will I be notified of upcoming appointments ?</span>} key="1">
            <Text>
              You will receive system notifications and can enable email or SMS alerts from your notification settings.
            </Text>
          </Panel>
          <Panel header={<span className="panelHeader">Where can I view all my upcoming appointments ?</span>} key="2">
            <Text>
              Go to the &quot;Appointments&quot; tab in your dashboard to see a list or calendar view of all your scheduled sessions.
            </Text>
          </Panel>
