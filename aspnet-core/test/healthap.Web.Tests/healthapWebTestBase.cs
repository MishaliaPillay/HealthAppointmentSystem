...
public abstract class healthapWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static healthapWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(healthapWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<healthapDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<healthapDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<healthapDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<healthapDbContext, Task<T>> func)
    {
        T result;
