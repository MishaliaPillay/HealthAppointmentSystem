...
namespace HealthAppointmentSystem.EntityFrameworkCore.Seed.Host;

public class DefaultLanguagesCreator
{
    public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

    private readonly HealthAppointmentSystemDbContext _context;

    private static List<ApplicationLanguage> GetInitialLanguages()
    {
        var tenantId = HealthAppointmentSystemConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(HealthAppointmentSystemDbContext context)
    {
        _context = context;
    }
