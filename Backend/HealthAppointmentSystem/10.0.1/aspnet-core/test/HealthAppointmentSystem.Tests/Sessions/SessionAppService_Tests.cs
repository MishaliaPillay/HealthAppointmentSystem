using HealthAppointmentSystem.Sessions;
using Shouldly;
using System.Threading.Tasks;
using Xunit;

namespace HealthAppointmentSystem.Tests.Sessions;

public class SessionAppService_Tests : HealthAppointmentSystemTestBase
{
