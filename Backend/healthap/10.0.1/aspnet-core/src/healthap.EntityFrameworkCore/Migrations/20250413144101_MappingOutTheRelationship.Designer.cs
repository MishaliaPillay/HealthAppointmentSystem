...
namespace healthap.Migrations
{
    ...
    [Migration("20250413144101_MappingOutTheRelationship")]
    partial class MappingOutTheRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("healthap.Domain.Location.ProviderLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("healthap.Domain.Persons.Patient", b =>
                {
                    ...
                    b.Property<string>("PreferredContactMedthodText")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("healthap.Domain.Specilality.Speciality", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("healthap.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("healthap.Domain.Appointments.Appointment", b =>
                {
                    b.HasOne("healthap.Domain.Location.Location", null)
            ...
            modelBuilder.Entity("healthap.Domain.Location.ProviderLocation", b =>
                {
                    b.HasOne("healthap.Domain.Location.Location", "Location")
